...
const ProfileControl = memo(
  ({ profileImage, profileName, username, email, about }) => {
                ...
                {about?.length ? (
                  <>
                    ...
                    <div className="flex flex-col gap-y-1 w-full word-break">
                      <p className="px-1 text-xs uppercase font-semibold text-primary">
                        About me
                      </p>
                      <div className="break-words">
                        <p className="px-1 leading-5 text-zinc-700 dark:text-zinc-400">
                          {about}
                        </p>
                      </div>
                    </div>
